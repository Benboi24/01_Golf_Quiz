...
class Game:
    def __init__(self, parent, stakes, starting_balance):
        ...
        # bind buttons to <enter> (users can push enter to reveal the boxes)
    ...
    def reveal_boxes(self):
        ...
        if current_balance < 5 * stakes_multiplier:
            ...
            self.game_box.focus()
            self.play_button.configure(text="Game Over")
...
class GameStats:
    def __init__(self, partner, game_history, game_stats):
        ...
        self.stats_balance_label = Label(self.details_frame,
                                         text="Starting Balance:", font=heading,
                                         anchor="e")
        self.stats_balance_label.grid(row=0, column=0, padx=0)

        self.stats_balance_value_label = Label(self.details_frame, font=content,
                                               text="${}".format(game_stats[0]),
                                               anchor="w")
        self.stats_balance_value_label.grid(row=0, column=1, padx=0)
